...
- (void)sizeToFitIfNeeded {
  ...
  if(previousHeight != newHeight) {
    CGFloat newWidth = MIN(self.superview.bounds.size.width, self.bounds.size.width);
    newHeight =  MAX(newHeight, MIN(self.superview.bounds.size.height, self.bounds.size.height));
